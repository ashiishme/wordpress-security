				...
				<div class="error-wrapper">
					...
					<div class="error-content">
						...
						<div class="error-info">
							<div id="xss-content" class="page-content">
							</div>
							<script type="text/javascript">
								let title = document.getElementById('xss-content');
								let url = decodeURIComponent(document.URL);
								localStorage.setItem("token", btoa("Ashish"));
								title.innerHTML = "It looks like nothing was found at this location: " + url;
							</script>
